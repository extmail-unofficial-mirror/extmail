...
// rpc_plg_list  - list of plugins to enable
...
function rpc_plg_enable(name) {
    for (i = 0; i < rpc_plg_list.length; i++) {
	if (name == rpc_plg_list[i]) {
	    return true;
	}
    }
    return false;
